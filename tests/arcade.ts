...
describe("arcade", () => {
  ...
  // 7 8 9 -> 7 8   -> 7     ->       ->       ->       ->       ->     ->   ->  -> 
  // 4 5 6 -> 4 5 9 -> 4 8 9 -> 7 8 9 -> 7 8   ->   8   ->       ->     ->   ->  ->
  // 1 2 3 -> 1 2 6 -> 1 5 6 -> 4 5 6 -> 4 5 9 -> 4 5 7 -> 4 5 8 -> 4 5 -> 4 ->  ->
  //==================================================================================
  //          ->          ->          ->          ->         ->    ->   ->          ->
  // 13 14 15 -> 13    15 ->       15 ->          ->         ->    ->   -> 19 20 21 ->
  // 10 11 12 -> 10 14 12 -> 10 13 12 -> 10 15 12 -> 10 _ 12 -> 10 ->   -> 16 17 18 ->
  //==================================================================================
  //          ->          ->          ->         ->        -> 
  //    20 21 ->       21 ->          ->         ->        -> 
  // 19 17 18 -> 20 17 18 -> 21 17 18 -> _ 17 18 -> _ _ 18 -> 
